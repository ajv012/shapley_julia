...
# passing a number here initiates the random sampling algorithm. All permutations will be randomly sampled twice instead of all permutations being considered.  
n_perms = 2; 
